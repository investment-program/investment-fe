...
export default function Serve() {
  ...
  const [payloadData, setPayloadData] = useState(null); // Result로 넘길 데이터를 저장
  ...
  // Update input value and filter suggestions
  ...
  // Prepare data to pass to Result
